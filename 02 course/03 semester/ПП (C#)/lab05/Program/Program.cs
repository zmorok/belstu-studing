...
namespace Program
{
    internal class Program
    {
        ...
        {
            string path = Path.Combine(Path.GetFullPath(Directory.GetCurrentDirectory()), "TEST_C");
            try 
            {
                ...
                else { Directory.SetCurrentDirectory(path); Console.WriteLine($"Директория {path} существует."); }
            }
