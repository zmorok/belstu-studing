...
namespace task04_05
{
    public partial class Abiturient : IComparable<Abiturient>
    {
        // уникальный ID, хэш
    ...
    {
        public string AbiturientSurname { get; }
        public string SubjectName { get; }
        public int Grade { get; }

        public Subject(string abiturientSurname, string subjectName, int grade)
        {
            AbiturientSurname = abiturientSurname;
