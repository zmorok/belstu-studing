...
__declspec(thread) int tlsPrimes[MAX_PRIMES_PER_THREAD];
...
int main(int argc, char* argv[])
{
    ...
    // деление диапазона на равные части
    ...
    if (waitRes == WAIT_FAILED) printf("Ошибка WaitForMultipleObjects, код = %lu\n", GetLastError());
