...
public class tank_script : MonoBehaviour {
	...
	float TankMoveSpeed = 0.1f;							// скорость движения танка
    ...
    private float SoundTargetVolume = 1f;
    ...
    void TankMovement()
	{
        ...
        float currentSpeed = TankMoveSpeed;             // ускорение при удержании Shift
